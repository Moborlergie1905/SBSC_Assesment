...
public class WithdrawWalletCommandHandler : IRequestHandler<WithdrawWalletBalanceCommand, int>
{
    ...
    public async Task<int> Handle(WithdrawWalletBalanceCommand request, CancellationToken cancellationToken)
    {
        if (request is null)
